<?php
	...
	if(isset($_POST['search']))
	{
	    ...
	    $query = "SELECT * FROM `futureproject` WHERE CONCAT(`id`, `name`,`assigned_emp`) LIKE '%".$valueToSearch."%'";
...
<html>
<head>
	<title>Future Projects | Project Manager</title>
...
<body>
	...
	<h2 class="h2">List of Future Projects</h2>
        ...
        <form action="futureproject.php" method="post">
            ...
            <div style="float: right;">
                <button title="Add new item" class="btn"><a style="text-decoration: none; color: white;" href="add_futureproject.php"> Add item</a></button>
            </div>
