    ...
    <div style="min-height: 500px;" class="container" >
      <div class="row">
        <div class="col-md-2">  <br>
          <a class="btn btn-success" href="projectinfo.php">Project List</a>
        </div>
        <div class="col-md-10">
          <br>
          <a class="btn btn-success" href="">Edit Project Information</a>
          <hr>


          <form action="edit_projectinfor.php?id=<?php echo $id ?>" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="start_date" placeholder="Starting of the project" value="<?php echo $std['start_date']?>">
            </div>

            <div class="form-group">
              <label for="Name">End Date:</label>
              <input type="text" class="form-control" name="end_date" placeholder="Ending period of the project" value="<?php echo $std['end_date']?>">
            </div>
