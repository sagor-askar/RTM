...
<html>
<head>
    <title>Requirements of Running Projects | Controller</title>
...
<body>
    ...
    <h2 class="h2">Requirements List of Running Projects</h2>
        
        <form action="running_project.php" method="post">
            ...
            <div style="float: right;">
                <button class="btn"><i class="fa fa-plus" aria-hidden="true"><a style="text-decoration: none; color: white;" href="insert.php">Add</a></i></button>
            </div>
