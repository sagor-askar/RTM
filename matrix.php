...
<body style="background-color: #d0e1e1">
	...
	<button class="add_projectinfo"><a style="text-decoration: none;" href="se_requirement.php">Back</a></button>
	<button class="add_projectinfo"><a style="text-decoration: none;" href="se_home.php">Home</a></button>
